...
function onSuccess(position) {
    ...
    api = `https://api.openweathermap.org/data/2.5/weather?lat=${latitude}&lon=${longitude}&units=metric&appid=d5ed6f181da77286263fe5da47eb0d8e`;
    fetchData()
}
...
function requestApi(city) {
    api = `https://api.openweathermap.org/data/2.5/weather?q=${city}&units=metric&appid=d5ed6f181da77286263fe5da47eb0d8e`;
    fetchData()
